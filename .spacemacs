...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(yasnippet-snippets
                                      prettier-js lsp-sonarlint obsidian
                                      )
  ...
  (custom-set-variables
   ...
   '(package-selected-packages
     '(a ace-link add-node-modules-path aggressive-indent aio alert all-the-icons
         ...
         closql code-cells code-review column-enforce-mode common-lisp-snippets
         company company-web consult consult-lsp consult-omni copilot copilot-chat
         cython-mode dactyl-mode deferred define-word devdocs diff-hl diminish
         ...
         parseclj parseedn password-generator pcre2el persistent-scratch
         ...
         sem sesman shell-maker shell-pop slim-mode slime slime-company smeargle
