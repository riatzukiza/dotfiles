...
This function is called at the very end of Spacemacs initialization."
  (custom-set-variables
   ...
   '(package-selected-packages
     '(ace-link add-node-modules-path aggressive-indent aio all-the-icons auctex
                auto-compile auto-highlight-symbol auto-yasnippet
                avy-jump-helm-line browse-at-remote centered-cursor-mode chatgpt
                clean-aindent-mode code-cells code-review codegpt
                column-enforce-mode company-web copilot cython-mode dactyl-mode
                dall-e define-word devdocs diff-hl diminish dired-quick-sort
                disable-mouse dotenv-mode drag-stuff dumb-jump eat edit-indirect
                editorconfig elisp-def elisp-demos elisp-slime-nav ellama
                ...
                gnuplot golden-ratio google-translate gptel grizzl helm-ag
                ...
                json-reformat jsonrpc link-hint live-py-mode livid-mode
                lorem-ipsum lsp-origami lsp-treemacs lsp-ui macrostep magit-popup
                markdown-toc mcp monokai-theme multi-line multi-term multi-vterm
                mwim nameless nodejs-repl npm-mode open-junk-file openai
                org-cliplink org-contrib org-download org-mime org-pomodoro
                org-present org-projectile org-rich-yank org-superstar orgalist
                orgit-forge overseer page-break-lines paradox password-generator
                pcre2el pip-requirements pipenv pippel poetry polymode popwin
                prettier-js pug-mode py-isort pydoc pyenv-mode pylookup pytest
                quickrun rainbow-delimiters request restart-emacs reveal-in-folder
                rjsx-mode sass-mode scss-mode shell-maker shell-pop slim-mode
                smeargle space-doc spaceline spacemacs-purpose-popwin
                spacemacs-whitespace-cleanup sphinx-doc string-edit-at-point
                string-inflection symbol-overlay symon systemd tablist tagedit
                tblui term-cursor terminal-here tern texfrag toc-org toml-mode
                ...
                web-mode wgrep which-key winum writeroom-mode ws-butler yaml-mode
                yasnippet-snippets)))
  (custom-set-faces
